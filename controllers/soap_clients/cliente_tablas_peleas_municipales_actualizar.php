...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
        // Get URL parameter
        $id =  trim($_GET["id"]);
        $cliente2 = new nusoap_client("http://localhost/BOMV/controllers/ws_soap/ws_tablas_peleas_municipales.php");
      ...
      <table class="table table-bordered table-responsive{-sm|-md|-lg|-xl} table-striped text-center">
        ...
        <tbody>
          ...
          <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
              <td class="pt-3-half"><input type="text" id="search_juez" maxlength="50" minlength="0" name="id_juez" value="<?php echo $id_juez; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="id_pelea" value="<?php echo $id_pelea; ?>"></td>
              <td class="pt-3-half"><input type="text" id="search_boxeador" name="id_boxeador" maxlength="50" minlength="0" value="<?php echo $id_boxeador; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round1" value="<?php echo $round1; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round2" value="<?php echo $round2; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round3" value="<?php echo $round3; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round4" value="<?php echo $round4; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round5" value="<?php echo $round5; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round6" value="<?php echo $round6; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round7" value="<?php echo $round7; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round8" value="<?php echo $round8; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round9" value="<?php echo $round9; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round10" value="<?php echo $round10; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round11" value="<?php echo $round11; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="round12" value="<?php echo $round12; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="total_puntos" value="<?php echo $total_puntos; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="num_jabs" value="<?php echo $num_jabs; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="num_power" value="<?php echo $num_power; ?>"></td>
              <td class="pt-3-half"><input type="number" maxlength="11" minlength="0" name="total_golpes" value="<?php echo $total_golpes; ?>"></td>
