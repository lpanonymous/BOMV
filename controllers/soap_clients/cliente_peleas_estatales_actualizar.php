...
$id = $categoria = $division = $id_juez1 = $id_juez2 = $id_juez3 = $id_juez4 = $id_boxeador1 = $id_boxeador2 = $fecha = $hora = $ganador = $nombre_foto="";
$id_err = $categoria_err = $division_err = $id_juez1_err = $id_juez2_err = $id_juez3_err = $id_juez4_err = $id_boxeador1_err = $id_boxeador2_err = $fecha_err = $hora_err = $ganador_err = $nombre_foto="";
...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($id_err) && empty($categoria_err)  && empty($division_err) && empty($id_juez1_err) && empty($id_juez2_err) && empty($id_juez3_err) && empty($id_juez4_err) && empty($id_boxeador1_err) && empty($id_boxeador2_err) && empty($fecha_err) && empty($hora_err) && empty($ganador_err)){
		...
		$datos = array('id' => $_POST["id"], 'categoria' => $_POST["categoria"],  'division' => $_POST["division"], 'id_juez1' => $_POST["id_juez1"], 'id_juez2' => $_POST["id_juez2"], 'id_juez3' => $_POST["id_juez3"], 'id_juez4' => $_POST["id_juez4"], 'id_boxeador1' => $_POST["id_boxeador1"], 'id_boxeador2' => $_POST["id_boxeador2"], 'fecha' => $_POST["fecha"], 'hora' => $_POST["hora"], 'ganador' => $_POST["ganador"], 'foto' => $decodeContent, 'nombre_foto' => $filename);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Por favor llena todos los datos y despues da clic en actualizar para almacenar los datos.</p>
                    ...
                    <div class="form-group <?php echo (!empty($categoria_err)) ? 'has-error' : ''; ?>">
						...
						<div class="form-group <?php echo (!empty($id_juez1_err)) ? 'has-error' : ''; ?>">
                            <label>Juez 1</label>
                            <input id="search_juez" type="text" name="id_juez1" maxlength="50" class="form-control" value="<?php echo $id_juez1; ?>">
                            <span class="help-block"><?php echo $id_juez1_err;?></span>
                        </div>

						<div class="form-group <?php echo (!empty($id_juez2_err)) ? 'has-error' : ''; ?>">
                            <label>Juez 2</label>
                            <input id="search_juez2" type="text" name="id_juez2"  maxlength="50" class="form-control" value="<?php echo $id_juez2; ?>">
                            <span class="help-block"><?php echo $id_juez2_err;?></span>
                        </div>

						<div class="form-group <?php echo (!empty($id_juez3_err)) ? 'has-error' : ''; ?>">
                            <label>Juez 3</label>
                            <input id="search_juez3" type="text" name="id_juez3" maxlength="50" minlength="1" class="form-control" value="<?php echo $id_juez3; ?>">
                        ...
                        <div class="form-group">
                            <img src="http://localhost/BOMV/resources/images/peleas_estatales/<?php echo $nombre_foto; ?>" class="img-fluid" alt="Imagen">
                            <div class="form-group">
                                <label>Foto</label>
                                <input type="file" name="foto" class="form-control" accept="image/*" value="http://localhost/BOMV/resources/images/peleas_estatales/<?php echo $nombre_foto; ?>" multiple> 
                            </div>
                        </div>
