...
<head>
    ...
    <title>Ver resultado de pelea municipal</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Alias del ganador</label>
                        <p class="form-control-static"><?php echo $aliasganador; ?></p>
                    </div>
                    <p><a href="../../views/resultados_peleas_municipales.php" class="btn btn-primary">Regresar</a></p>
                </div>
            </div>        
        </div>
    </div>
