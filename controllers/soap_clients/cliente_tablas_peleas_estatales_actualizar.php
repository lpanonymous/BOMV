...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $datos = array('id' => $_POST["id"], 
		...
		$resultado = $cliente->call('editarTablaPeleaEstatal', $datos);
    ...
    $resultado = $cliente2->call('buscarTablaPeleaEstatal', $datos);
...
<div class="card">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Actualizar tabla de pelea estatal<span class="table-add float-right mb-3 mr-2"><a href="#!" class="text-success"><i class="fas fa-plus fa-2x" aria-hidden="true"></i></a></span></h3>
  <div class="card-body">
