...
<div class="card">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Detalle de tabla de pelea municipal <span class="table-add float-right mb-3 mr-2"></span></h3>
  <div class="card-body">
