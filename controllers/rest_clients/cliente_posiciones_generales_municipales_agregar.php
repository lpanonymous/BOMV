...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($alias_boxeador_err) && empty($gimnasio_err) && empty($categoria_err) && empty($division_err))
    {
        ...
        $ch = curl_init("http://localhost/BOMV/controllers/ws_rest/posiciones_generales_municipales_rest.php");
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Crear posición municipal</h2>
                    </div>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group <?php echo (!empty($alias_boxeador_err)) ? 'has-error' : ''; ?>">
                            ...
                            <input id="search_boxeador" type="text" name="alias_boxeador" maxlength="100" minlength="0" class="form-control" value="<?php echo $alias_boxeador; ?>">
                            <span class="help-block"><?php echo $alias_boxeador_err;?></span>
                        </div>
                        <div class="form-group <?php echo (!empty($gimnasio_err)) ? 'has-error' : ''; ?>">
                            <label>Gimnasio</label>
                            <input id="search_gimnasio" type="text" name="gimnasio" maxlength="50" minlength="0" class="form-control" value="<?php echo $gimnasio; ?>">
                        ...
                        <div class="form-group <?php echo (!empty($peleas_ganadas_err)) ? 'has-error' : ''; ?>">
                            ...
                            <input type="number" name="peleas_ganadas" maxlength="11" minlength="0" class="form-control" value="<?php echo $peleas_ganadas; ?>" min="0">
                        ...
                        <div class="form-group <?php echo (!empty($peleas_perdidas_err)) ? 'has-error' : ''; ?>">
                            ...
                            <input type="number" name="peleas_perdidas" maxlength="11" minlength="0" class="form-control" value="<?php echo $peleas_perdidas; ?>" min="0">
                            <span class="help-block"><?php echo $peleas_perdidas_err;?></span>
                        </div>
                        <div class="form-group <?php echo (!empty($empates_err)) ? 'has-error' : ''; ?>">
                            <label>#Empates</label>
                            <input type="number" name="empates" maxlength="11" minlength="0" class="form-control" value="<?php echo $empates; ?>" min="0">
