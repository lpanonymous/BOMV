...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($id_err) && empty($categoria_err) && empty($id_juez1_err) && empty($id_juez2_err) && empty($id_juez3_err) && empty($id_juez4_err) && empty($id_boxeador1_err) && empty($id_boxeador2_err) && empty($fecha_err) && empty($hora_err)){
        ...
        $sql = "INSERT INTO peleas_estatales_categoria_varonil (id, categoria, id_juez1, id_juez2, id_juez3, id_juez4, id_boxeador1, id_boxeador2, fecha, hora) VALUES ('{$_POST["id"]}', '{$_POST["categoria"]}', '{$_POST["id_juez1"]}', '{$_POST["id_juez2"]}', '{$_POST["id_juez3"]}', '{$_POST["id_juez4"]}', '{$_POST["id_boxeador1"]}', '{$_POST["id_boxeador2"]}', '{$_POST["fecha"]}', '{$_POST["hora"]}')";
...
<head>
    <meta charset="UTF-8">
    <title>Crear pelea estatal categoria varonil</title>
