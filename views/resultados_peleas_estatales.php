...
<meta charset="UTF-8">
    ...
    <style type="text/css">
		...
		@media
	  only screen 
    and (max-width: 550px), (min-device-width: 868px) 
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		...
		td:nth-of-type(2):before { content: "Id boxeador 1:"; }
		td:nth-of-type(3):before { content: "Id boxeador 2:"; }
		td:nth-of-type(4):before { content: "Peso:"; }
		td:nth-of-type(5):before { content: "Id Ganador:"; }
		td:nth-of-type(6):before { content: "Funciones:"; }
