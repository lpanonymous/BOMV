    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" href="tablas_peleas_estatales.php">Tablas de peleas estatales</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="../../controllers/soap_clients/cliente_vtablas_peleas_estatales_agregar.php" class="btn btn-info pull-right">Agregar nueva tabla de pelea</a>
                    </div>
                    <?php
