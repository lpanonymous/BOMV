...
<meta charset="UTF-8">
    ...
    <title>Peleas Municipales</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="../../controllers/soap_clients/cliente_peleas_municipales_agregar.php" class="btn btn-info pull-right">Agregar nueva pelea municipal</a>
                    </div>
                    <?php
